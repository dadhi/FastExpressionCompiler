...
namespace FastExpressionCompiler.Benchmarks
{
    ...
    public class ExprInfoVsExpr_CreateAndCompile_ComplexExpr
    {
        ...
        ------------------------------------- |----------:|----------:|----------:|------:|--------:|------------:|------------:|------------:|--------------------:|
         CreateExpressionInfo_and_CompileFast |  12.68 us | 0.0555 us | 0.0492 us |  1.00 |    0.00 |      1.4343 |      0.7172 |      0.0458 |             6.61 KB |
    ...
    public class ExprInfoVsExpr_Create_ComplexExpr
    {
        ...
        ## 25.01.2019
                       ...
                       Method |       Mean |     Error |    StdDev | Ratio | RatioSD | Gen 0/1k Op | Gen 1/1k Op | Gen 2/1k Op | Allocated Memory/Op |
        --------------------- |-----------:|----------:|----------:|------:|--------:|------------:|------------:|------------:|--------------------:|
         CreateExpressionInfo |   389.5 ns | 0.9547 ns | 0.7972 ns |  1.00 |    0.00 |      0.1693 |           - |           - |               800 B |
