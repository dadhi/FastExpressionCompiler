...
namespace FastExpressionCompiler.Benchmarks
{
    ...
    [MemoryDiagnoser]
    public class ObjectExecutorBenchmark_AsyncExecutor_InvokeAsync
    {
        public async Task<string> Foo(int a, int b) => await Task.FromResult((a + b).ToString());

        private static readonly Type _t = typeof(ObjectExecutorBenchmark_AsyncExecutor_InvokeAsync);
