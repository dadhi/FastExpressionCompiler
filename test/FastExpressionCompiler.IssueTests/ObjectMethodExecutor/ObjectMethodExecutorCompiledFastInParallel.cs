...
{
    public class ObjectMethodExecutorCompiledFastInParallel
    {
        ...
        private ObjectMethodExecutorCompiledFastInParallel(MethodInfo methodInfo, TypeInfo targetTypeInfo, object[] parameterDefaultValues)
        {
            if (methodInfo == null)
            {
        ...
        public static ObjectMethodExecutorCompiledFastInParallel Create(MethodInfo methodInfo, TypeInfo targetTypeInfo)
        {
            return new ObjectMethodExecutorCompiledFastInParallel(methodInfo, targetTypeInfo, null);
        }

        public static ObjectMethodExecutorCompiledFastInParallel Create(MethodInfo methodInfo, TypeInfo targetTypeInfo, object[] parameterDefaultValues)
        {
            ...
            return new ObjectMethodExecutorCompiledFastInParallel(methodInfo, targetTypeInfo, parameterDefaultValues);
        }
            ...
            CoercedAwaitableInfo coercedAwaitableInfo)
        {
            ...
            return lambda.TryCompileInParallelAsync<MethodExecutorAsync>().Result;
        }
    }
}