...
{
    public class ObjectMethodExecutorCompiledFastClosure
    {
        ...
        public static ObjectMethodExecutorCompiledFastClosure Create(MethodInfo methodInfo, TypeInfo targetTypeInfo)
        {
            return new ObjectMethodExecutorCompiledFastClosure(methodInfo, targetTypeInfo, null);
        }

        public static ObjectMethodExecutorCompiledFastClosure Create(MethodInfo methodInfo, TypeInfo targetTypeInfo, object[] parameterDefaultValues)
        {
            ...
            return new ObjectMethodExecutorCompiledFastClosure(methodInfo, targetTypeInfo, parameterDefaultValues);
        }
