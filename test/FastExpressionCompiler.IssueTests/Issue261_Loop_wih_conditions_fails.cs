...
p[0]=Parameter(typeof(PrimitiveValue), "result")
  ...
  public void Test_class_items_array_index_via_variable_access_then_the_member_access()
  {
    ...
    Asserts.AreEqual("13", fs(new[] { new El() }, 0));
  ...
  public void Test_struct_items_array_index_via_variable_access_then_the_member_access()
  {
    ...
    Asserts.AreEqual("14", f(new[] { new ElVal("14", 43) }, 0));
  }
  ...
  public void Test_method_to_expression_code_string()
  {
    ...
    Asserts.AreEqual("Read", m.Name);

    var s = new StringBuilder().AppendMethod(m, true, null).ToString();
    Asserts.AreEqual("typeof(Issue261_Loop_wih_conditions_fails.BufferedStream).GetMethods().Where(x => x.IsGenericMethod && x.Name == \"Read\" && x.GetParameters().Length == 0 && x.GetGenericArguments().Length == 1).Select(x => x.IsGenericMethodDefinition ? x.MakeGenericMethod(typeof(int)) : x).Single()", s);
    ...
    Asserts.AreEqual("typeof(Issue261_Loop_wih_conditions_fails.BufferedStream).GetMethods().Single(x => !x.IsGenericMethod && x.Name == \"Read\" && x.GetParameters().Length == 0)", s);
  ...
  public void Test_triple_nested_non_generic()
  {
    ...
    Asserts.AreEqual("Issue261_Loop_wih_conditions_fails.A<int>.B<string>.Z", s);

    s = typeof(A<int>.B<string>.Z).ToCode();
    Asserts.AreEqual("FastExpressionCompiler.LightExpression.IssueTests.Issue261_Loop_wih_conditions_fails.A<int>.B<string>.Z", s);
  ...
  public void FindMethodOrThrow_in_the_class_hierarchy()
  {
    ...
    e.CompileFast(true)();
    Asserts.AreEqual(4, bar.MethodIndex);
