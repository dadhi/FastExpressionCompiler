...
public class Issue274_Failing_Expressions_in_Linq2DB : ITest
{
  ...
  public void Test_287_Case1_ConvertTests_NullableParameterInOperatorConvert_VerificationException()
  {
    ...
    var fs = expr.CompileSys();
    fs.PrintIL();
    Asserts.AreEqual(new CustomMoneyType { Amount = 1.11m }, fs(1.11m));

    var fx = expr.CompileFast(true);
    fx.PrintIL();
    Asserts.AreEqual(new CustomMoneyType { Amount = 1.11m }, fx(1.11m));
  }
  ...
  public void Test_283_Case6_MappingSchemaTests_CultureInfo_VerificationException()
  {
    ...
    var fs = expr.CompileSys();
    fs.PrintIL();
    Asserts.AreEqual("20.01.2012 16:30:40", fs(new DateTime(2012, 1, 20, 16, 30, 40)));

    var fx = expr.CompileFast(true);
    fx.PrintIL();
    Asserts.AreEqual("20.01.2012 16:30:40", fx(new DateTime(2012, 1, 20, 16, 30, 40)));
  }
  ...
  public void Test_283_Case2_Minimal_NullRefException()
  {
    ...
    Asserts.AreEqual(FlagsEnum.All, (FlagsEnum)flags);
  }
