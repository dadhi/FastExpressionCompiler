...
namespace FastExpressionCompiler.UnitTests
{
    public class Program
    {
        ...
        {
            new Issue419_The_JIT_compiler_encountered_invalid_IL_code_or_an_internal_limitation().Run();
            // new Issue421_Date_difference_is_giving_wrong_negative_value().Run();
            // new ArithmeticOperationsTests().Run();
            // new LightExpression.IssueTests.Issue418_Wrong_output_when_comparing_NaN_value().Run();
            // new LightExpression.IssueTests.Issue422_InvalidProgramException_when_having_TryCatch_Default_in_Catch().Run();
        ...
        public static void RunAllTests()
        {
            ...
            var issueTests = Task.Run(() =>
            {
                ...
                Run(new LightExpression.IssueTests.Issue65_Add_LightExpression_Elvis_operator_support().Run);
                ...
                Run(new LightExpression.IssueTests.Issue231_ExpressionNew_does_not_work_with_struct().Run);
                ...
                Run(new Issue341_Equality_comparison_between_nullable_and_null_inside_Any_produces_incorrect_compiled_expression().Run);
